export default function memePage() {
  let audio = new Audio('audiocafea.mp3');
  audio.play();
  document.querySelector('.app').style.background = 'url(liminalpool.jpg)';
  ...
  document.querySelector('.keyboard').style.background = 'url(keyboard.png)';
